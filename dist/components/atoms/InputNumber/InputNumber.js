...
var InputNumber = function (_a) {
    ...
    var onChange = function (e) {
        ...
        if (value1) {
            ...
            var float = +value2;
            result = isNaN(float) ? helpers_1.numberWithSpaces(integer, groupBy, separator) : [helpers_1.numberWithSpaces(integer, groupBy, separator), value2].join('.');
        }
    ...
    var handleDefault = function (v) {
        ...
        if (val.includes('.')) {
            ...
            var result = [helpers_1.numberWithSpaces(+values[0]), values[1]].join('.');
            setValue(result);
        }
        else {
            val ? setValue(helpers_1.numberWithSpaces(+val)) : setValue(val);
        }
    };
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(Input_1.default, __assign({}, props, { value: value, placeholder: props.placeholder, disabled: props.disabled, readOnly: props.readOnly, onChange: onChange, onKeyPress: onKeyPress })),
