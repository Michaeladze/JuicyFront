...
var Tabs = function (_a) {
    ...
    var onClick = function (e, i, element) {
        ...
        setActive(i);
        if ((_a = list[i]) === null || _a === void 0 ? void 0 : _a.handler) {
            // @ts-ignore
    ...
    var nav = list.map(function (t, i) {
        ...
        return (react_1.default.createElement("div", { key: i, className: 'rf-tabs__link', ref: refs.current[i] },
            react_1.default.createElement("button", { type: 'button', className: "rf-tabs__button " + className, disabled: t.disabled, onClick: handler },
                !!t.icon && react_1.default.createElement("div", { className: 'rf-tabs__icon' }, t.icon),
                !!t.label && react_1.default.createElement("div", null, t.label))));
    });
