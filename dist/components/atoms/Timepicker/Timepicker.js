...
var Timepicker = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "rf-timepicker__wrapper " + (className || '') + " " + (disabled ? 'rf-timepicker__disabled' : '') },
        react_1.default.createElement(react_input_mask_1.default, { mask: [
                ...
                /[0-5]/,
                /[0,5,8]/
            ], value: time, disabled: disabled, alwaysShowMask: true, readOnly: props.readOnly, onChange: onChange },
            react_1.default.createElement(Input_1.default, __assign({}, props))),
        react_1.default.createElement("div", { className: 'rf-timepicker__menu' },
            react_1.default.createElement(Menu_1.default, { position: 'right', content: content },
                react_1.default.createElement(Button_1.default, { buttonType: 'text', disabled: disabled },
                    react_1.default.createElement(index_1.Time, { className: 'rf-timepicker__icon' }))))));
};
