...
var DatepickerCalendar = function (_a) {
    var value = _a.value, setInputValue = _a.setInputValue, showCalendar = _a.showCalendar, toggleCalendar = _a.toggleCalendar, minDate = _a.minDate, maxDate = _a.maxDate, toggleRef = _a.toggleRef, range = _a.range, locale = _a.locale, showTodayButton = _a.showTodayButton, position = _a.position, format = _a.format, separator = _a.separator, disableWeekDays = _a.disableWeekDays;
    var contentRef = react_1.useRef(null);
    // -------------------------------------------------------------------------------------------------------------------
    var setCurrent = react_1.useCallback(function () {
        if (value && !range) {
            return datepicker_utils_1.stringToDate(value, format);
        }
        return new Date();
    }, [value, range]);
    var setRange = function () {
        ...
        if (value && range) {
            ...
            return [from ? datepicker_utils_1.stringToDate(from, format) : undefined, to ? datepicker_utils_1.stringToDate(to, format) : undefined];
        }
    ...
    var onDateChange = function (date) {
        ...
        if (range) {
            ...
            if (dates[0] === undefined) {
                dates[0] = date;
                setInputValue(datepicker_utils_1.formatDate(date.getTime(), format).date + (" - __" + separator + "__" + separator + "____"));
            }
            else {
                dates[1] = date;
                ...
                var newValue = datepicker_utils_1.formatDate((_b = dates[0]) === null || _b === void 0 ? void 0 : _b.getTime(), format).date + " - " + datepicker_utils_1.formatDate((_c = dates[1]) === null || _c === void 0 ? void 0 : _c.getTime(), format).date;
                setInputValue(newValue);
                toggleCalendar(false);
            }
        }
        else {
            setInputValue(datepicker_utils_1.formatDate(date.getTime(), format).date);
            setCurrentDate(date);
            toggleCalendar(false);
        }
        setPeriodType('day');
        ...
        react_1.default.createElement("header", { className: 'rf-datepicker__calendar-header' },
            react_1.default.createElement("div", { className: 'rf-calendar__control' },
                react_1.default.createElement("button", { type: 'button', className: 'rf-calendar__button rf-calendar__button--arrow rf-calendar__button-prev', disabled: prevArrowDisabled, onClick: function () { return onPeriodChange(-1); } },
                    react_1.default.createElement("span", { className: 'rf-datepicker__calendar-left' },
                ...
                react_1.default.createElement("button", { type: 'button', className: 'rf-calendar__button rf-calendar__button--arrow rf-calendar__button-next', disabled: nextArrowDisabled, onClick: function () { return onPeriodChange(1); } },
                    react_1.default.createElement("span", { className: 'rf-datepicker__calendar-right' },
                        react_1.default.createElement(index_1.ChevronLeft, null)))),
            showTodayButton && (react_1.default.createElement("button", { type: 'button', className: 'rf-datepicker__calendar-today', disabled: todayDisabled, onClick: function () { return onDateChange(new Date()); } }, locale === 'ru' ? 'Сегодня' : 'Today'))),
