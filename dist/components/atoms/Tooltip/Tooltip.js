...
var Tooltip = function (_a) {
    var children = _a.children, _b = _a.position, position = _b === void 0 ? 'right' : _b, _c = _a.isVisible, isVisible = _c === void 0 ? true : _c, _d = _a.className, className = _d === void 0 ? '' : _d, _e = _a.portal, portal = _e === void 0 ? false : _e, _f = _a.background, background = _f === void 0 ? 'default' : _f;
    var _g = react_1.useState(null), tooltipRect = _g[0], setTooltipRect = _g[1];
    ...
    return (react_1.default.createElement("div", { className: "rf-tooltip rf-tooltip--" + background, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave, onClick: stopPropagation, onMouseUp: stopPropagation },
        children[0],
