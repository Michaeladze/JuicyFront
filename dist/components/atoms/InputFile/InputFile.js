...
var InputFile = function (_a) {
    var _b = _a.name, name = _b === void 0 ? '' : _b, _c = _a.accept, accept = _c === void 0 ? '*' : _c, _d = _a.multiple, multiple = _d === void 0 ? false : _d, _e = _a.className, className = _e === void 0 ? '' : _e, _f = _a.defaultValue, defaultValue = _f === void 0 ? '' : _f, _g = _a.disabled, disabled = _g === void 0 ? false : _g, _h = _a.placeholder, placeholder = _h === void 0 ? '' : _h, _j = _a.files, files = _j === void 0 ? [] : _j, setFile = _a.setFile, onError = _a.onError, maxSize = _a.maxSize, count = _a.count, _k = _a.showChips, showChips = _k === void 0 ? true : _k, customPlaceholder = _a.customPlaceholder, props = __rest(_a, ["name", "accept", "multiple", "className", "defaultValue", "disabled", "placeholder", "files", "setFile", "onError", "maxSize", "count", "showChips", "customPlaceholder"]);
    /** Файл */
    var _l = react_1.useState(function () { return files; }), file = _l[0], uploadFile = _l[1];
    /** Ссылка на инпут */
    ...
    var fileChips = file.map(function (f) {
        var id = f.file.name + f.file.lastModified;
        return (react_1.default.createElement("div", { key: id, className: 'file-input__tag' },
            react_1.default.createElement(Tag_1.default, { onRemove: function () { return onFileRemove(id); } }, f.file.name)));
    });
    ...
    return (react_1.default.createElement("div", { className: 'file-input__wrapper' },
        react_1.default.createElement("label", { className: "" + (className || '') },
            ...
            react_1.default.createElement(Button_1.default, __assign({}, props, { type: 'button', className: 'file-input__button', onClick: onClick, disabled: disabled }), customPlaceholder || placeholder)),
        showChips && file.length > 0 && (react_1.default.createElement("div", { className: 'file-input__chips' }, fileChips))));
};
